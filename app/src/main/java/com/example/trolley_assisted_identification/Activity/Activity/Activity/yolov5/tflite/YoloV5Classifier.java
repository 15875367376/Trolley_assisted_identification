...
package com.example.trolley_assisted_identification.Activity.Activity.Activity.yolov5.tflite;
...
import com.example.trolley_assisted_identification.Activity.Activity.Activity.yolov5.env.Logger;
...
//        byteBuffer.order(ByteOrder.nativeOrder());
    ...
    public ArrayList<Recognition> recognizeImage(Bitmap bitmap) {
        ...
        Log.d("数组图像转换 ", " bytrBuffer= " + byteBuffer_);
...
//                Log.d("RectF","W1 = " + Math.max(0, xPos - w / 2) + "H1 = " + Math.max(0, yPos - h / 2) + "W2 = " + Math.min(bitmap.getWidth() - 1, xPos + w / 2) + "H2 = " + Math.min(bitmap.getHeight() - 1, yPos + h / 2));
            }

        }

        Log.d("YoloV5Classifier", "detect end"+detections);
        final ArrayList<Recognition> recognitions = nms(detections);

        Log.d("recognitions","return:"+recognitions);
        return recognitions;
    }
