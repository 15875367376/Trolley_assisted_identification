...
//        Plate[] recognizedPlates = PlateRecognitionFromImage(ctxHandle_, buf, height, width, rotation, format);
//        for (Plate plate : recognizedPlates) {
//            plates.add(plate);
//        }
//        return plates.toArray(new Plate[0]);
